...
+ (void)playMediaWithURL:(NSString *)contentVideoUrl andVastTagURL:(NSString *)vastTagUrl andShowUpSecondForMidrollAd:(int)seconds{
    ...
    NSBundle *bundle = [NSBundle bundleWithURL:[[NSBundle mainBundle] URLForResource:@"AdPlayerUI" withExtension:@"bundle"]];
    
    AdViewController *adViewController = [[AdViewController alloc] initWithNibName:@"AdVideoPlayer" bundle:bundle];
